...
import { SiNextdotjs, SiExpress,SiMysql,SiMongodb,SiXampp,SiPostman,SiVisualstudiocode,SiGnubash,SiLatex } from "react-icons/si";
...
const skillsData=[
    {
      ...
      },
      {
        ...
        skills: [
            ...
            {  name: "VS Code", description: "Source code editor",icon: <SiVisualstudiocode/> },
