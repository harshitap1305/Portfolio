...
<div className="contact-container">
  ...
  <div className="contact-details">
    <p><FaEnvelope className="contact-icon" /> <b>Email:</b> <a href="mailto:harshitapatidar257@gmail.com">your.email@example.com</a></p>
    <p><FaPhone className="contact-icon" /> <b>Phone:</b> +91 7447079410 | +91 9406256247</p>
    <p><FaLinkedin className="contact-icon" /> <b>LinkedIn:</b> 
      <a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer">harshita-patidar</a>
    </p>
