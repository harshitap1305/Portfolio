...
import { SiNextdotjs, SiExpress,SiMysql,SiMongodb,SiXampp,SiPostman,SiGnubash,SiLatex } from "react-icons/si";
import { FaCode } from "react-icons/fa";
import { SiC,Si } from 'react-icons/si';
...
const skillsData=[
    {
        category: "Languages",
        skills: [
          { name: "C", description: "Procedural programming language", icon: <FaReact/> },
          { name: "C++", description: "Object-oriented programming language", icon: <FaHtml5 /> },
          { name: "Javascript", description: "Scripting language for web development", icon: <FaCss3Alt /> },
