...
<h2 className="con-title">Contact Information</h2>
<div className="contact-container">

  <div className="contact-details">
    <p><FaEnvelope className="contact-icon" /> <b>Email:</b> <a href="mailto:your.email@example.com">your.email@example.com</a></p>
    <p><FaPhone className="contact-icon" /> <b>Phone:</b> +91 XXXXX XXXXX</p>
    ...
    <p><FaGithub className="contact-icon" /> <b>GitHub:</b> 
      <a href="https://github.com/yourgithub" target="_blank" rel="noopener noreferrer"> github.com/yourgithub</a>
    </p>
  </div>
</div>
    </>
