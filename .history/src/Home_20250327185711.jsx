...
const skillsData=[
    {
      ...
      },
      {
        category: "Backend",
        skills: [
          { name: "Node.js", description: "Frontend Library", icon: <FaNodeJs /> },
          { name: "Express.js", description: "Markup Language", icon: <SiExpress /> },
          { name: "PHP", description: "Styling", icon: <FaCode /> }
        ]
      },
      {
        category: "Frontend",
